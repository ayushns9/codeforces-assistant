...
const CheckSolved = require('./CheckSolved.js')

module.exports = {
    RandomProblem : async function (rating, user1, user2) {
        ...
        }while(await CheckSolved.CheckSolved(user1, choosen_problem.contestId, choosen_problem.index) || await CheckSolved.CheckSolved(user2, choosen_problem.contestId, choosen_problem.index));
